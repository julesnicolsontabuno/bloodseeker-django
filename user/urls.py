...
urlpatterns = [
    ...
    path('<user>/editDetails/<hospital1>/<org1>', views.editDetailsView.as_view(), name="editDetails"),
    path('<user>/viewDetails/<hospital1>', views.viewDetailsView.as_view(), name="viewDetails"),
]
