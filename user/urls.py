...
urlpatterns = [
    ...
    path('<user>/accreditedHospital',
         views.accreditedHospitalView.as_view(), name="accreditedHospital"),
    ...
    path('<user>/requestAppointment',
         views.requestAppointmentView.as_view(), name="requestAppointment"),
]
